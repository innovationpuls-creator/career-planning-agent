...
class CareerDevelopmentPlanStepSubmission(Base):
    __tablename__ = "career_development_plan_step_submissions"
    ...
    submission_json: Mapped[str] = mapped_column(Text, nullable=False, default="{}")
