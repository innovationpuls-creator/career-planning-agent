...
```json
{"event":"route","data":{"agent":"CareerMatchCoach","rule":"L2_keyword","matched":"岗位匹配"}}
```
...
```json
{"event":"tool_call","data":{"tool_call_id":"call_1","tool_name":"get_job_categories","tool_args":{"industry":"互联网"}}}
{"event":"tool_result","data":{"tool_call_id":"call_1","tool_name":"get_job_categories","result":{"categories":[{"name":"软件开发","industry":"互联网"},{"name":"数据分析","industry":"互联网"},{"name":"产品经理","industry":"互联网"}]}}}
```
